...
const (
	// Server templates
	TplPOJO             = "server/pojo"
	TplController       = "server/controller"
	TplControllerMethod = "server/controller_method"

	// Client templates
	TplHTTPClient       = "client/http_client"
	TplApacheHTTPClient = "client/apache_http_client"
...
func GetDefaultRegistry() *Registry {
	defaultRegistryOnce.Do(func() {
		loader := NewLoader(EmbeddedTemplates, "java", DefaultFuncMap)
