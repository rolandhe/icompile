...
// EnterGo_package is called when production go_package is entered.
func (s *BaseServiceListener) EnterGo_package(ctx *Go_packageContext) {}

// ExitGo_package is called when production go_package is exited.
func (s *BaseServiceListener) ExitGo_package(ctx *Go_packageContext) {}
...
// EnterStruct_hint is called when production struct_hint is entered.
func (s *BaseServiceListener) EnterStruct_hint(ctx *Struct_hintContext) {}

// ExitStruct_hint is called when production struct_hint is exited.
func (s *BaseServiceListener) ExitStruct_hint(ctx *Struct_hintContext) {}
...
// EnterPut_ is called when production put_ is entered.
func (s *BaseServiceListener) EnterPut_(ctx *Put_Context) {}

// ExitPut_ is called when production put_ is exited.
func (s *BaseServiceListener) ExitPut_(ctx *Put_Context) {}
