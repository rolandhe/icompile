...
type ServiceListener interface {
	...
	// EnterGo_package is called when entering the go_package production.
	EnterGo_package(c *Go_packageContext)
	...
	// EnterStruct_hint is called when entering the struct_hint production.
	EnterStruct_hint(c *Struct_hintContext)
	...
	// EnterPut_ is called when entering the put_ production.
	EnterPut_(c *Put_Context)
	...
	// ExitGo_package is called when exiting the go_package production.
	ExitGo_package(c *Go_packageContext)
	...
	// ExitStruct_hint is called when exiting the struct_hint production.
	ExitStruct_hint(c *Struct_hintContext)
	...
	// ExitPut_ is called when exiting the put_ production.
	ExitPut_(c *Put_Context)
